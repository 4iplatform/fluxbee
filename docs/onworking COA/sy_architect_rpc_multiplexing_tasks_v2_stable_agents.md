...
Date: 2026-06-01
Updated: 2026-06-01 (resolution pass v3: no AI splits, Vault scope wide, this doc is now one chapter of the global RouterDispatcher unification plan)
Status: Draft
...
or, if startup ordering requires late initialization:
