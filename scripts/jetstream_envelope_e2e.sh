...
#   JETSTREAM_DIAG_SUBJECT="jetstream.diag.envelope"
#   JETSTREAM_DIAG_QUEUE="durable.jetstream.diag.envelope"
...
JETSTREAM_DIAG_SUBJECT="${JETSTREAM_DIAG_SUBJECT:-jetstream.diag.envelope}"
JETSTREAM_DIAG_QUEUE="${JETSTREAM_DIAG_QUEUE:-durable.jetstream.diag.envelope}"
...
echo "Starting JetStream envelope diag server: NATS_URL=$NATS_URL SUBJECT=$JETSTREAM_DIAG_SUBJECT QUEUE=$JETSTREAM_DIAG_QUEUE SID=$JETSTREAM_DIAG_SID FAIL_FIRST_N=$JETSTREAM_DIAG_FAIL_FIRST_N"
(
  cd "$ROOT_DIR"
