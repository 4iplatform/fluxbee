...
impl Config {
    pub fn load() -> Result<Self, ConfigError> {
        ...
        Ok(Self {
            ...
            shm_prefix: router_config.paths.shm_prefix,
            config_dir,
            scan_interval_ms: 250,
            fib_refresh_ms: 1_000,
            hello_interval_ms: router_config.timers.hello_interval_ms,
            dead_interval_ms: router_config.timers.dead_interval_ms,
            heartbeat_interval_ms: router_config.timers.heartbeat_interval_ms,
